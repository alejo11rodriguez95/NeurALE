...
/**
 * Copia local del patrón de tarjeta de opción de Outbound
 * (`src/modules/outbound/components/OptionCard.tsx`). Se duplica a propósito
 * en vez de importar entre módulos o crearla en `shared/` sin pedirlo primero
 * en el chat de Setup y Diseño — si el patrón se repite en más módulos,
 * conviene promoverlo a un componente compartido ahí.
 */
