...
/**
 * Tarjeta de opción dentro del menú de un módulo (ver `DashboardHome`). Vive
 * local al Dashboard (copia de la de Outbound/Picking/Admin) — si Picking y otros módulos terminan
